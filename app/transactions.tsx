...
export default function TransactionsScreen() {
  ...
  const handleDownloadReceipt = async (t: UnifiedTransaction) => {
    try {
      ...
      if (Platform.OS === 'web') {
        // On web, this seamlessly triggers the browser's print dialog (allowing "Save as PDF")
        await Print.printAsync({ html: htmlContent });
      } else {
        // On mobile, this creates the PDF and opens the native iOS/Android share sheet
