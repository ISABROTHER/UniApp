  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Utilities + StuMark</Text>
      </View>

      <View style={styles.tabRow}>
        {([['meters', 'Meters'], ['topup', 'Top Up'], ['history', 'History'], ['stumark', 'StuMark']] as [TabType, string][]).map(([t, label]) => (
        ...
        {loading ? (
          ...
          <>
            <View style={styles.stumarkHeader}>
              ...
              <TouchableOpacity style={styles.createBtn} onPress={() => alert('Create new listing coming soon!')}>
